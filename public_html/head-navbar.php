...
<head>
    ...
    <link href="libs/thirdparty/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="libs/thirdparty/select2.min.css">
    <link rel="stylesheet" href="libs/thirdparty/select2-bootstrap-5-theme.min.css">
        ...
        <div class="container-fluid">
            <a class="navbar-brand p-0 me-0 text-center col-1" href="#">
               ...
               <li class="nav-item">
                ...
                <?php if($_SESSION['cargo'] == intval(getenv('ROLE_ADMIN'))){ ?>
            ...
            <div class="navbar-nav ms-auto dropdown">
                <input class="btn btn-outline-success dropdown-toggle me-2 text-white" value="<?=htmlspecialchars($_SESSION['nome_usuario'])?>" type="button" data-bs-toggle="dropdown" aria-expanded="false">
