...
<body style="background-color:#212529; text-align:center; margin-top:50px; color:#ffffff; font-family:Arial, sans-serif;">
    <h1>403</h1>
    <h2>Acesso Proibido</h2>
    <svg style="width: 10em; height: 10em;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sign-stop" viewBox="0 0 16 16">
