    ...
    <main class="mt-5 p-4" style="width: 32rem;">
        ...
        <form action="index.php" method="POST">
            ...
            <div class="form-text text-light mt-3">
                ...
                <a href="register.php" class="text-info">Cadastre-se</a>
            </div>
        </form>
    </main>
