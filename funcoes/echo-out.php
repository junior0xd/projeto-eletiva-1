<?php function echoSucesso($mensagem){ //ideia: adicionar em uma classe e passar as classes desejadas como parametros também ?>
...
<?php } ?>
<?php function echoAlertaWarning($mensagem){ ?>
...
<?php } ?>
<?php function echoAlertaDanger($mensagem){  ?>
