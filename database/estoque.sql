...
(10, 'Clips de Papel', 'Pacote de clips para organização de documentos.', 400, 100, NULL, 2),
...
(15, 'Termômetro de Mercúrio', 'Termômetro tradicional de mercúrio para medição de temperatura.', 5, 8, '2026-03-15', 1),
(16, 'Fita Adesiva Transparente', 'Fita adesiva transparente para uso em escritório.', 5, 3, NULL, 2),
(17, 'Luvas Cirúrgicas Estéreis', 'Luvas cirúrgicas estéreis para procedimentos médicos.', 10, 20, '2024-12-01', 1),
(18, 'Bloco de Notas Autoadesivas', 'Bloco de notas autoadesivas para lembretes.', 300, 35, NULL, 2),
(19, 'Máscara N95', 'Máscara respiratória N95 para proteção avançada.', 10, 15, '2025-11-30', 1),
...
(23, 'Sonda Nasogástrica', 'Sonda para alimentação enteral.', 85, 90, '2026-02-28', 1),
